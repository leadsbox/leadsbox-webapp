...
export function TelegramIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox='0 0 152 152' aria-hidden='true' {...props}>
      ...
      <path fill='#fff' d='M111.77 45.32c-.45.13-.87.33-1.3.5l-59.78 24.56q-6.43 2.62-12.85 5.39a1.57 1.57 0 0 0-.84.93c0 .2.47.6.79.81a8.09 8.09 0 0 0 1.28.55c7.13 2.88 14.25 5.79 21.39 8.62l.26.12 1.69 18.46a1.91 1.91 0 0 0 .21.74 1.31 1.31 0 0 0 2 .45c4-3.35 8-6.71 12-10.15a2 2 0 0 1 2.63-.24c5.61 3 11.26 6 16.9 9 3.34 1.77 3.36 1.76 4.19-1.94l10.14-45.63c.83-3.71 1.64-7.43 2.45-11.09.14-.91-.35-1.33-1.16-1.08zm-13.25 14.43q-13.52 14.88-26.99 29.76a9.56 9.56 0 0 0-1.3 1.86c-1.72 3.26-3.39 6.53-5.09 9.23a1.49 1.49 0 0 1-2.07.72 1.4 1.4 0 0 1-.82-1.14l-.69-7.76 25.38-27.93a2 2 0 0 0 .41-2.2 2.11 2.11 0 0 0-2.43-1.14l-34.73 10.33-7.55-2.66a.5.5 0 0 1-.17-.85 1 1 0 0 1 .36-.24l64.94-25.2a1.49 1.49 0 0 1 1.12 0 1 1 0 0 1 .43.54 1.5 1.5 0 0 1 .07.72c-.83 3.67-1.64 7.38-2.46 11.09z'/>
    </svg>
  );
}
