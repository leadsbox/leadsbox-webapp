      ...
      <main className="container mx-auto px-4 py-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none space-y-6">
            ...
            <p>
              Some features may require a paid subscription. Pricing and features are subject to change with notice. Fees are non‑refundable except where required by law.
            </p>

            <h3>Content and Data</h3>
            <p>
              You retain ownership of your content. You grant us a limited license to process your data to deliver the service, subject to our <Link to="/privacy" className="text-primary">Privacy Policy</Link>.
            </p>
            ...
            <h3>Termination</h3>
            <p>
              We may suspend or terminate your access for breach of these Terms. You may stop using the service at any time.
            </p>

            <h3>Disclaimer and Limitation of Liability</h3>
            <p>
              The service is provided "as is" without warranties of any kind. To the maximum extent permitted by law, LeadsBox will not be liable for indirect or consequential damages.
            </p>
            ...
            <h3>Contact</h3>
            <p>
              Questions? Contact us at <a href="mailto:support@leadsbox.app" className="text-primary">support@leadsbox.app</a>.
            </p>

            <div className="flex items-center justify-between pt-4">
              <Link to="/register" className="text-sm text-primary hover:underline">Back to Register</Link>
